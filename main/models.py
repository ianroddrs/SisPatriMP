...
class Cidade(models.Model):
    ...
    polo = models.ForeignKey('main.polo', on_delete=models.CASCADE, related_name='cidades')
...
class Local(models.Model):
    nome = models.CharField(max_length=100)
    cidade = models.ForeignKey('main.cidade', on_delete=models.CASCADE, related_name='locais')
